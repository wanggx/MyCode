...
class DesignViewController : UIViewController,SKSplashDelegate
{
    ...
    {
        print("the indexTag is \(indexTag)")
        
        let diyViewController:DIYViewController = UIStoryboard(name: "DIYView", bundle: nil).instantiateViewControllerWithIdentifier("DIYViewControllerID") as! DIYViewController
    ...
    func splashView(splashView: SKSplashView!, didBeginAnimatingWithDuration duration: Float) {
        ...
        print("the delegate method 1 is animation")
