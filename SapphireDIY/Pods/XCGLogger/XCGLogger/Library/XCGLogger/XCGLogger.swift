...
public class XCGBaseLogDestination: XCGLogDestinationProtocol, CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        get {
            return "\(Mirror(reflecting: self.dynamicType).description): \(identifier) - LogLevel: \(outputLogLevel.description()) showFunctionName: \(showFunctionName) showThreadName: \(showThreadName) showLogLevel: \(showLogLevel) showFileName: \(showFileName) showLineNumber: \(showLineNumber) showDate: \(showDate)"
        }
    }
...
public class XCGLogger: CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        get {
            ...
            var description: String = "\(Mirror(reflecting: self.dynamicType).description): \(identifier) - logDestinations: \r"
            for logDestination in logDestinations {
