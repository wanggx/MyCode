...
class DIYViewController: UIViewController,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,BottomMenuFunctionEvent
{
    ...
    var diySceneViewController:UIViewController = UIStoryboard(name: "DIYView", bundle: nil).instantiateViewControllerWithIdentifier("diySceneID") 
    ...
    func addBottomToolButton()
    {
        ...
        let btnDis:CGFloat = 20
        let btnStartX = (self.view.frame.width - btnDis*3 - 40*4)/2 - 12
    ...
    func bottomAddTextFunction(sender:UIButton)
    {
        ...
        print("the bottom is \(isBottomPopViewOpen)")
    ...
    func bottomAddLogoFounction(sender:UIButton)
    {
        ...
        print("the isBottomPopViewOpen is \(isBottomPopViewOpen)")
    }
    ...
    {
        print("touch sapce close handle button is clicked")
        print("I got this mes ***************************")
        bottomFunctionButtonFlyUp(1)
        if isBottomPopViewOpen == true{
        isBottomPopViewOpen = !isBottomPopViewOpen
        }
        print("the isbottom is \(isBottomPopViewOpen)")
    }
    ...
    func addSceneView()
    {
        print("this is the make of the scene View")
