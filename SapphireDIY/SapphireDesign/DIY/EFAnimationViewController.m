...
- (void)configViews {
    ...
    NSArray *dataArray = @[@"Man.png", @"Woman.png", @"kids-crew.png", @"pullover-Hoodie.png", @"T-shirt.png"];
...
//    }
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%ld",index] forKey:@"EFButtonViewIndex"];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SelectDesignViewController" object:self userInfo:dic];
