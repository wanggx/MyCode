...
def select(date_str):
    ...
    join_df = join_df[['select_date_d', 'ts_code', 'name', 'ma35_3_d', 'ma35_5_d','ma3_d', 'ma5_d',
                       'ma35_3_w', 'ma35_5_w', 'ma3_w', 'ma5_w', 'macd_gloden_d', 'dif_d', 'dea_d',
                       'macd_d', 'macd_gloden_w', 'dif_w', 'dea_w', 'macd_w', 'kdj_gloden_d',
                       'k_d', 'd_d', 'j_d', 'kdj_gloden_w', 'k_w', 'd_w', 'j_w']].round(2)
